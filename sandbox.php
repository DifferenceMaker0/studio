...
curl \
--ssl-reqd \
--url 'smtp://sandbox.smtp.mailtrap.io:465' \
--user 'f51b8526873ccf:d3a7528a243702' \
--mail-from noreply@collabstudio.online \
--mail-rcpt differencemaker0@gmail.com \
--upload-file - <<EOF
From: CollabStudio <noreply@collabstudio.online>
To: Mailtrap Inbox <differencemaker0@gmail.com>
